  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        /* NewForm editorial palette — azure-blue variant
           (neutrals are faintly blue-tinted instead of green-tinted) */
        linen: "#f9fcff",
        ink: "#10131a",
        bark: "#1f2430",
        sage: "#525d72",
      ...
      boxShadow: {
        voltage:
          "rgba(16, 19, 26, 0.10) 0px 18px 40px -12px, rgba(16, 19, 26, 0.06) 0px 6px 14px -8px",
      },
      borderRadius: {
        lg: "var(--radius)",
